...
int main()
{
	...
	cout << endl;
	cout << "Group 3 Final Project" << endl;
	cout << "Name of File: final.txt" << endl;

	while (choice != 4)			//User Menu
	{
		cout << endl;
		cout << "Choose from the following options:" << endl;
		cout << "1. Trimm File" << endl;
		cout << "2. Build File" << endl;
		cout << "3. Convert to C++" << endl;
		cout << "4. Quit" << endl;
		cout << "Selection: ";
		cin >> choice;
		cout << endl;
		...
		default:
			cout << "Invalid selection, please select an appropriate option from the menu!" << endl;
		}
	}
...
int parser(string line, int fail)
{
	...
	*/
	...
	while (!itemstack.empty())		//While the stack is not empty
	{
		...
		else
		{
			...
			if (!match)
			{
				...
				{
				case 99:
					cout << "REJECTED: The String you entered is not accepted by this grammar!" << endl;
					fail++;
				...
				case 29:		//PRINT( <output> );
					...
					cout << "PUSHED " << itemstack.top() << endl;
					outfile << "PUSHED " << itemstack.top() << endl;
					itemstack.push('!');										//p bound to print
	...
	cout << "ACCEPTED: The word you entered is accepted by this grammar!" << endl;
	outfile << "ACCEPTED: The word you entered is accepted by this grammar!" << endl;
...
int find(string need, string variables[], int fail)
{
	...
	if (match == false)
	{
		cout << need << " is expected, please check that it is not missing or mispelled!" << endl;
		fail++;
	}
	else
		match = false;
